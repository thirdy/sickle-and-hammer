...
/**
 * Based on IBM developer works article on Java Preferences API <br/>
 * http://www.ibm.com/developerworks/libary/j-prefapi
 */
public class PrefObj {
    ...
    static public Object getObject(Preferences prefs, String key) throws IOException, BackingStoreException,
            ClassNotFoundException {
